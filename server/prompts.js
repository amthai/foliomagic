const prompts = {
  ...
  product_designer: {
    ...
    system: "Ты эксперт по карьерному консультированию для продуктовых дизайнеров. Создавай резюме, максимально соответствующие требованиям вакансий на hh.ru. Включай ключевые слова и навыки из анализа актуальных вакансий.",
...
- Контакты и город: используй точные данные из формы "{contacts}" и "{city}"`
  ...
  web_designer: {
    name: "Веб-дизайнер",
    system: "Ты эксперт по карьерному консультированию для веб-дизайнеров. Создавай резюме, максимально соответствующие требованиям вакансий на hh.ru. Включай ключевые слова и навыки из анализа актуальных вакансий.",
...
- Контакты и город: используй точные данные из формы "{contacts}" и "{city}"`
  ...
  product_manager: {
    ...
    system: "Ты эксперт по карьерному консультированию для продакт менеджеров. Создавай резюме, максимально соответствующие требованиям вакансий на hh.ru. Включай ключевые слова и навыки из анализа актуальных вакансий.",
